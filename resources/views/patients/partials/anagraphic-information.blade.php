<section>
    ...
    <form method="post" action="{{ route('editPatient', $patient->id) }}" class="mt-6 space-y-6">
        ...
        <div class="pt-4 pb-1 bordo-t-3 border-black dark:border-gray-600 mt-4 flex flex-col gap-3">
            ...
            <x-select name="gender" class="block mt-1 w-full anagrafica" :options="['Maschio' => 'M', 'Femmina' => 'F', 'Non specificato' => 'non specificato']" :selected="old('gender', $patient->gender)" disabled />
