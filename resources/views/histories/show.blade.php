    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div id="tabs" class="flex flex-wrap gap-2 justify-center sm:justify-start mb-4">
                <button data-tab="physiological" class="tab-btn bg-white text-gray-700 border border-gray-300 rounded-full px-4 py-1.5 text-lg hover:bg-orange-200 transition">
                    Fisiologia
                </button>
                <button data-tab="familiar" class="tab-btn bg-white text-gray-700 border border-gray-300 rounded-full px-4 py-1.5 text-lg hover:bg-orange-200 transition">
                    Familiare
                </button>
                <button data-tab="remote-pathological" class="tab-btn bg-white text-gray-700 border border-gray-300 rounded-full px-4 py-1.5 text-lg hover:bg-orange-200 transition">
                    Patologica Remota
                </button>
                <button data-tab="next-pathological" class="tab-btn bg-white text-gray-700 border border-gray-300 rounded-full px-4 py-1.5 text-lg hover:bg-orange-200 transition">
                    Patologica Prossima
                </button>
            </div>
            <!-- Tab Contents -->
